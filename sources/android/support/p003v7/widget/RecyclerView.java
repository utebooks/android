...
import android.support.p003v7.recyclerview.C0274R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a2 = context.obtainStyledAttributes(attrs, C0274R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a2.getString(C0274R.styleable.RecyclerView_layoutManager);
            if (a2.getInt(C0274R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    public void swapAdapter(C0337Adapter adapter, boolean removeAndRecycleExistingViews) {
    ...
    public void setAdapter(C0337Adapter adapter) {
        setLayoutFrozen(false);
    ...
    private void setAdapterInternal(C0337Adapter adapter, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
        ...
        C0337Adapter oldAdapter = this.mAdapter;
    ...
    public C0337Adapter getAdapter() {
    ...
    public static class RecycledViewPool {
        ...
        /* access modifiers changed from: package-private */
        public void attach(C0337Adapter adapter) {
            this.mAttachCount++;
        }
        ...
        /* access modifiers changed from: package-private */
        public void onAdapterChanged(C0337Adapter oldAdapter, C0337Adapter newAdapter, boolean compatibleWithPrevious) {
            if (oldAdapter != null) {
                detach();
            }
    ...
    public static abstract class C0337Adapter<VH extends ViewHolder> {
    ...
    public static abstract class LayoutManager {
        ...
        public int getItemCount() {
            C0337Adapter a = this.mRecyclerView != null ? this.mRecyclerView.getAdapter() : null;
            if (a != null) {
        ...
        public void onAdapterChanged(C0337Adapter oldAdapter, C0337Adapter newAdapter) {
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0274R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0274R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0274R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0274R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0274R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public static class State {
        ...
        /* access modifiers changed from: package-private */
        public void prepareForNestedPrefetch(C0337Adapter adapter) {
            this.mLayoutStep = 1;
