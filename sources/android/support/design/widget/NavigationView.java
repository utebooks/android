...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0012R.styleable.NavigationView, defStyleAttr, C0012R.style.Widget_Design_NavigationView);
        setBackgroundDrawable(a.getDrawable(C0012R.styleable.NavigationView_android_background));
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0270R.attr.colorPrimary, value, true)) {
            return null;
        }
