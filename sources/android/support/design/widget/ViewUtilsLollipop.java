...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float targetElevation) {
        ...
        sla.addState(new int[]{16842766, C0012R.attr.state_collapsible, C0012R.attr.state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", new float[]{targetElevation}));
        sla.addState(new int[]{16842766, C0012R.attr.state_collapsible, -C0012R.attr.state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}));
        sla.addState(new int[]{16842766, -C0012R.attr.state_collapsible}, ObjectAnimator.ofFloat(view, "elevation", new float[]{targetElevation}));
