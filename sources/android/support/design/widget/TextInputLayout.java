...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0012R.styleable.TextInputLayout, defStyleAttr, C0012R.style.Widget_Design_TextInputLayout);
        ...
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                try {
                    ...
                    this.mErrorView.setTextAppearance(getContext(), C0270R.style.TextAppearance_AppCompat_Caption);
    ...
    public void setError(@Nullable final CharSequence error) {
        ...
        if (!ViewCompat.isLaidOut(this) || TextUtils.equals(this.mErrorView.getText(), error)) {
            animate = false;
        } else {
            animate = true;
        }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0270R.style.TextAppearance_AppCompat_Caption);
