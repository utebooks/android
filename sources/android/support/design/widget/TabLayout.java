...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0270R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0270R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0270R.styleable.TextAppearance_android_textColor);
            ta.recycle();
    ...
    public Tab newTab() {
        ...
        TabLayout unused = tab.mParent = this;
        TabView unused2 = tab.mView = createTabView(tab);
        return tab;
    }
