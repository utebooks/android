...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0270R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        this.mScrimVisibleHeightTrigger = a.getInt(C0012R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
            ...
            if (this.mDrawCollapsingTitle) {
                ...
                collapsingTextHelper.setCollapsedBounds(i3, titleMarginTop, titleMarginEnd + i4, (bottom - bottomOffset) - this.mToolbar.getTitleMarginBottom());
                CollapsingTextHelper collapsingTextHelper2 = this.mCollapsingTextHelper;
                int i5 = isRtl ? this.mExpandedMarginEnd : this.mExpandedMarginStart;
                int i6 = this.mExpandedMarginTop + this.mTmpRect.bottom;
                int i7 = right - left;
                if (isRtl) {
                ...
                collapsingTextHelper2.setExpandedBounds(i5, i6, i7 - i, (bottom - top) - this.mExpandedMarginBottom);
