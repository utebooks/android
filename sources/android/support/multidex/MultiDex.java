...
public final class MultiDex {
    ...
    private static void doInstallation(android.content.Context r9, java.io.File r10, java.io.File r11, java.lang.String r12, java.lang.String r13) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.reflect.InvocationTargetException, java.lang.NoSuchMethodException {
        /*
            ...
            monitor-enter(r6)
            java.util.Set<java.io.File> r5 = installedApk     // Catch:{ all -> 0x006f }
            boolean r5 = r5.contains(r10)     // Catch:{ all -> 0x006f }
        ...
        L_0x000f:
            java.util.Set<java.io.File> r5 = installedApk     // Catch:{ all -> 0x006f }
            r5.add(r10)     // Catch:{ all -> 0x006f }
            int r5 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x006f }
            ...
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x006f }
            int r8 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x006f }
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x006f }
            ...
            java.lang.String r8 = java.lang.System.getProperty(r8)     // Catch:{ all -> 0x006f }
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x006f }
            java.lang.String r8 = "\""
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x006f }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x006f }
            android.util.Log.w(r5, r7)     // Catch:{ all -> 0x006f }
        L_0x0060:
            java.lang.ClassLoader r3 = r9.getClassLoader()     // Catch:{ RuntimeException -> 0x0072 }
            if (r3 != 0) goto L_0x007c
            java.lang.String r5 = "MultiDex"
            java.lang.String r7 = "Context class loader is null. Must be running in test mode. Skip patching."
            android.util.Log.e(r5, r7)     // Catch:{ all -> 0x006f }
            monitor-exit(r6)     // Catch:{ all -> 0x006f }
            goto L_0x000e
        L_0x006f:
            r5 = move-exception
        ...
        L_0x0072:
            ...
            android.util.Log.w(r5, r7, r1)     // Catch:{ all -> 0x006f }
            monitor-exit(r6)     // Catch:{ all -> 0x006f }
            goto L_0x000e
        L_0x007c:
            clearOldDexDir(r9)     // Catch:{ Throwable -> 0x008d }
        L_0x007f:
            java.io.File r0 = getDexDir(r9, r11, r12)     // Catch:{ all -> 0x006f }
            r5 = 0
            java.util.List r2 = android.support.multidex.MultiDexExtractor.load(r9, r10, r0, r13, r5)     // Catch:{ all -> 0x006f }
            installSecondaryDexes(r3, r0, r2)     // Catch:{ all -> 0x006f }
            monitor-exit(r6)     // Catch:{ all -> 0x006f }
            goto L_0x000e
        L_0x008d:
            r4 = move-exception
            ...
            android.util.Log.w(r5, r7, r4)     // Catch:{ all -> 0x006f }
            goto L_0x007f
        */
    ...
    private static final class C0075V4 {
        private C0075V4() {
        }
