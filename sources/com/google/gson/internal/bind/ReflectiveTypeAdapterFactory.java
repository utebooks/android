...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        return new C0666Adapter(this.constructorConstructor.get(type), getBoundFields(gson, type, raw));
    }
    ...
    public static final class C0666Adapter<T> extends TypeAdapter<T> {
        private final Map<String, BoundField> boundFields;
        private final ObjectConstructor<T> constructor;

        C0666Adapter(ObjectConstructor<T> constructor2, Map<String, BoundField> boundFields2) {
