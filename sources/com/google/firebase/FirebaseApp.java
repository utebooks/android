...
public class FirebaseApp {
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (zzrs) {
            zzaa.zza(!zzaTZ.containsKey(zzhF), (Object) new StringBuilder(String.valueOf(zzhF).length() + 33).append("FirebaseApp name ").append(zzhF).append(" already exists!").toString());
