...
public class zzy extends zzm.zza {
    ...
    public void zzfD(String str) throws SecurityException {
        ...
        if (!com.google.android.gms.common.util.zzy.zzd(this.zzbbl.getContext(), myUid, str)) {
            if (!com.google.android.gms.common.util.zzy.zze(this.zzbbl.getContext(), myUid) || this.zzbbl.zzGh()) {
