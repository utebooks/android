...
public interface zzm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzm {
        ...
        private static class C0782zza implements zzm {
        ...
        public static zzm zzdv(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzm)) ? new C0782zza(iBinder) : (zzm) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 7:
                    parcel.enforceInterface("com.google.android.gms.measurement.internal.IMeasurementService");
                    List<UserAttributeParcel> zza = zza(parcel.readInt() != 0 ? (AppMetadata) AppMetadata.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0);
                    parcel2.writeNoException();
