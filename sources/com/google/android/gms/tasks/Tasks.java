...
public final class Tasks {
    ...
    private static final class zzc implements zzb {
        ...
        private void zzMQ() {
            ...
            int i = this.zzbwG;
            zzh.setException(new ExecutionException(new StringBuilder(54).append(i).append(" out of ").append(this.zzbwE).append(" underlying tasks failed").toString(), this.zzbwC));
        }
