...
public interface zzsg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsg {
        ...
        private static class C0781zza implements zzsg {
        ...
        public static zzsg asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsg)) ? new C0781zza(iBinder) : (zzsg) queryLocalInterface;
        }
