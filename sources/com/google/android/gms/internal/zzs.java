...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C0780zza> zzak = new ArrayList();
        ...
        private static class C0780zza {
            public final String name;
            public final long time;
            public final long zzam;

            public C0780zza(String str, long j, long j2) {
                this.name = str;
                this.zzam = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzak.add(new C0780zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (zzw > 0) {
                ...
                long j2 = j;
                for (C0780zza next : this.zzak) {
                    long j3 = next.time;
                    zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(next.zzam), next.name);
                    j2 = j3;
                }
            }
        }
