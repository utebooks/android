...
public interface zzpq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpq {
        ...
        private static class C0776zza implements zzpq {
        ...
        public static zzpq zzbb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpq)) ? new C0776zza(iBinder) : (zzpq) queryLocalInterface;
        }
