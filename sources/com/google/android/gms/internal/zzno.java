...
public interface zzno extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzno {
        ...
        private static class C0773zza implements zzno {
        ...
        public static zzno zzaQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzno)) ? new C0773zza(iBinder) : (zzno) queryLocalInterface;
        }
