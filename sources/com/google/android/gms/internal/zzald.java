...
public final class zzald<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void zza(zzd<K, V> zzd2, zzd<K, V> zzd3) {
        ...
        if (zzd4 == null) {
            ...
            zzd4.zzbXr = zzd3;
        } else if ($assertionsDisabled || zzd4.zzbXs == zzd2) {
            zzd4.zzbXs = zzd3;
        } else {
    ...
    public zzd<K, V> zza(K k, boolean z) {
        ...
        zzd<K, V> zzd4 = this.zzbXg;
        if (zzd4 != null) {
            Comparable comparable = comparator == zzbXf ? (Comparable) k : null;
            while (true) {
                int compareTo = comparable != null ? comparable.compareTo(zzd4.zzbIt) : comparator.compare(k, zzd4.zzbIt);
                if (compareTo == 0) {
                    return zzd4;
                }
                zzd<K, V> zzd5 = compareTo < 0 ? zzd4.zzbXr : zzd4.zzbXs;
                if (zzd5 == null) {
                    int i2 = compareTo;
                    zzd2 = zzd4;
                    i = i2;
        ...
        zzd<K, V> zzd6 = this.zzbXh;
        if (zzd2 != null) {
            zzd3 = new zzd<>(zzd2, k, zzd6, zzd6.zzbXt);
            if (i < 0) {
                zzd2.zzbXr = zzd3;
            } else {
                zzd2.zzbXs = zzd3;
