...
public interface zznn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznn {
        ...
        private static class C0772zza implements zznn {
        ...
        public static zznn zzaP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznn)) ? new C0772zza(iBinder) : (zznn) queryLocalInterface;
        }
