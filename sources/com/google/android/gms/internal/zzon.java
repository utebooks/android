...
public interface zzon extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzon {
        ...
        private static class C0774zza implements zzon {
        ...
        public static zzon zzaR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzon)) ? new C0774zza(iBinder) : (zzon) queryLocalInterface;
        }
