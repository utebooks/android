    ...
    public Long zzdr(String str) {
        ...
        synchronized (this) {
            while (this.zzatN.size() >= this.zzatM) {
                ...
                j /= 2;
                Log.w("ConnectionTracker", new StringBuilder(94).append("The max capacity ").append(this.zzatM).append(" is not enough. Current durationThreshold is: ").append(j).toString());
            }
