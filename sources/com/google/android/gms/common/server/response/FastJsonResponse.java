...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public String toString() {
            ...
            sb.append("                 typeIn=").append(this.zzasJ).append(10);
            sb.append("            typeInArray=").append(this.zzasK).append(10);
            sb.append("                typeOut=").append(this.zzasL).append(10);
            sb.append("           typeOutArray=").append(this.zzasM).append(10);
            sb.append("        outputFieldName=").append(this.zzasN).append(10);
            sb.append("      safeParcelFieldId=").append(this.zzasO).append(10);
            sb.append("       concreteTypeName=").append(zzun()).append(10);
            if (zzum() != null) {
                sb.append("     concreteType.class=").append(zzum().getCanonicalName()).append(10);
            }
            sb.append("          converterName=").append(this.zzasS == null ? "null" : this.zzasS.getClass().getCanonicalName()).append(10);
            return sb.toString();
        }
    ...
    private void zza(StringBuilder sb, Field field, Object obj) {
        if (field.zzud() == 11) {
            sb.append(((FastJsonResponse) field.zzum().cast(obj)).toString());
        ...
        for (String next : zzuf.keySet()) {
            ...
            if (zza(field)) {
                ...
                if (zza2 != null) {
                    switch (field.zzue()) {
                        case 8:
                            sb.append("\"").append(zzc.zzk((byte[]) zza2)).append("\"");
                            break;
                        case 9:
                            sb.append("\"").append(zzc.zzl((byte[]) zza2)).append("\"");
                            break;
                        case 10:
