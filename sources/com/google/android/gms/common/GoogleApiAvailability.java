...
public class GoogleApiAvailability extends zzc {
    ...
    public Dialog zza(Activity activity, DialogInterface.OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(C0380R.string.common_google_play_services_updating_text, new Object[]{zzam}));
        builder.setTitle(C0380R.string.common_google_play_services_updating_title);
