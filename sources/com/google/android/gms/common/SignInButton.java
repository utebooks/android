...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private void zza(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0380R.styleable.SignInButton, 0, 0);
        try {
            this.mSize = obtainStyledAttributes.getInt(C0380R.styleable.SignInButton_buttonSize, 0);
            this.mColor = obtainStyledAttributes.getInt(C0380R.styleable.SignInButton_colorScheme, 2);
            String string = obtainStyledAttributes.getString(C0380R.styleable.SignInButton_scopeUris);
            if (string == null) {
                this.zzakD = null;
            } else {
