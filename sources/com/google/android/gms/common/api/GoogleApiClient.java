...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        private GoogleApiClient zzru() {
            ...
            Api api3 = null;
            for (Api next : this.zzalj.keySet()) {
                ...
                if (next.zzrf()) {
                    ...
                    Api api4 = zzrd.getPriority() == 1 ? next : api3;
                    zza = zza(zzrd, (Object) apiOptions, this.mContext, this.zzakW, zzrt, (ConnectionCallbacks) zznw, (OnConnectionFailedListener) zznw);
                    api = api4;
                } else {
                    Api.zza zzrc = next.zzrc();
                    Api api5 = zzrc.getPriority() == 1 ? next : api3;
                    zza = zza(zzrc, (Object) apiOptions, this.mContext, this.zzakW, zzrt, (ConnectionCallbacks) zznw, (OnConnectionFailedListener) zznw);
                    api = api5;
                }
                arrayMap2.put(next.zzre(), zza);
                if (!zza.zzps()) {
                    next = api2;
                } else if (api2 != null) {
