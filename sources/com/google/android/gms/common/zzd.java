...
class zzd {
    ...
    static abstract class zza extends zzs.zza {
        ...
        protected zza(byte[] bArr) {
            zzaa.zzb(bArr.length == 25, (Object) new StringBuilder(55).append("cert hash data has incorrect length. length=").append(bArr.length).toString());
