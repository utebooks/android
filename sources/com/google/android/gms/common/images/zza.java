...
public abstract class zza {
    ...
    static final class C0752zza {
        public final Uri uri;

        public C0752zza(Uri uri2) {
            this.uri = uri2;
        }

        public boolean equals(Object obj) {
            if (!(obj instanceof C0752zza)) {
                return false;
            }
            if (this == obj) {
                return true;
            }
            return zzz.equal(((C0752zza) obj).uri, this.uri);
        }
    ...
    public static final class zzb extends zza {
        ...
        private void zza(ImageView imageView, Drawable drawable, boolean z, boolean z2, boolean z3) {
            ...
            if (imageView instanceof zzpi) {
                ...
                zzpi.zzbX(z4 ? this.zzapM : 0);
            }
            if (zzb) {
                ((zzph) zza).startTransition(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION);
            }
        }
