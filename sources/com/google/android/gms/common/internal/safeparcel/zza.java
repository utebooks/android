...
public class zza {
    ...
    public static class C0753zza extends RuntimeException {
        /* JADX WARNING: Illegal instructions before constructor call */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public C0753zza(java.lang.String r5, android.os.Parcel r6) {
            /*
                r4 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.safeparcel.zza.C0753zza.<init>(java.lang.String, android.os.Parcel):void");
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            throw new C0753zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i2).append(" got ").append(zza).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            throw new C0753zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i3).append(" got ").append(i2).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    public static int zzaq(Parcel parcel) {
        ...
        if (zzcj(zzap) != 20293) {
            ...
            throw new C0753zza(valueOf.length() != 0 ? "Expected object header. Got 0x".concat(valueOf) : new String("Expected object header. Got 0x"), parcel);
        }
        int i = dataPosition + zza;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C0753zza(new StringBuilder(54).append("Size read is invalid start=").append(dataPosition).append(" end=").append(i).toString(), parcel);
    }
